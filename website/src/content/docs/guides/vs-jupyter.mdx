---
title: MLOps Desktop vs Jupyter Notebooks
description: When to use MLOps Desktop instead of Jupyter, and when notebooks are still the right choice.
---
...
| Feature | MLOps Desktop | Jupyter Notebooks |
|---------|---------------|-------------------|
...
<Aside type="tip">
If you've ever heard "It works on my machine," MLOps Desktop helps prevent that.
</Aside>
...
Ready to try MLOps Desktop? [Download now](/getting-started/installation/) or [see the quickstart](/getting-started/quickstart/).
