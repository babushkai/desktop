---
title: Use Cases
description: When MLOps Desktop is the right tool for your ML workflow.
---
...
<Aside type="caution">
MLOps Desktop may not be the right choice for these scenarios.
</Aside>
...
| Use Case | MLOps Desktop | Cloud ML Platform |
|----------|---------------|-------------------|
...
[Open a discussion on GitHub](https://github.com/babushkai/desktop/discussions) and we'll help you figure out the best approach.
