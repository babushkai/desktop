...
description: Integrate Kissaten AI with MLflow for experiment tracking and model registry.
---

import { Aside, Steps } from '@astrojs/starlight/components';

MLflow is an open-source platform for managing the ML lifecycle. This guide shows how to use Kissaten AI alongside MLflow for enhanced experiment tracking.

<Aside type="note">
Kissaten AI and MLflow solve different problems and work great together:
- **Kissaten AI**: Visual pipeline building, local training
...
After exporting from Kissaten AI:
...
def log_experiment(model_path: str, meta_path: str):
    """Log an Kissaten AI export to MLflow."""
...
<Steps>
1. Build and iterate in Kissaten AI
...
<Steps>
1. Each team member uses Kissaten AI locally
...
Use consistent names across Kissaten AI and MLflow:
...
Log additional artifacts from Kissaten AI:
...
### What Kissaten AI doesn't do (use MLflow for):
...
### What MLflow doesn't do (use Kissaten AI for):
...
Kissaten AI and MLflow complement each other:

1. **Build and iterate** in Kissaten AI (visual, fast, local)
...
**Next steps:**
- [Install Kissaten AI](/getting-started/installation/)
