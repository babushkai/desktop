...
description: Solutions to common issues with MLOps Desktop.
---

import { Aside, Steps } from '@astrojs/starlight/components';

This guide covers common issues and their solutions. If you don't find your issue here, please [open a GitHub issue](https://github.com/babushkai/desktop/issues).
...
3. Try downloading the latest version from [GitHub Releases](https://github.com/babushkai/desktop/releases)
...
<Steps>
1. Go to [GitHub Issues](https://github.com/babushkai/desktop/issues)
2. Click "New Issue"
3. Include:
...
Open a [GitHub Discussion](https://github.com/babushkai/desktop/discussions) to propose new features.
