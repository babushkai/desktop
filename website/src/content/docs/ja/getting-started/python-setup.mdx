---
title: Pythonセットアップ
description: Kissaten AI用にPythonと必要なパッケージを設定
---

import { Tabs, TabItem, Steps, Aside } from '@astrojs/starlight/components';

Kissaten AIは、システムにインストールされたPythonを使用してMLパイプラインを実行します。
...
Kissaten AIを使用するには、以下のPythonパッケージが必要です。
...
このパスをKissaten AIで設定すると、パッケージのバージョンが固定されます。
...
```bash
which pip3
# Kissaten AIで設定したPythonと一致しているか確認
```
